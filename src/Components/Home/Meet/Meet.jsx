...
const Meet = () => {
    ...
    return (
        <div>
            ...
            {/* <div className='flex flex-col md:flex-row lg:flex-row justify-evenly items-center p-10'>
                ...
                <div className='w-full md:w-[40%] lg:w-[40%] mx-auto text-center my-5'>
                    ...
                    <h1 className='text-2xl md:text-3xl lg:text-4xl font-semibold leading-relaxed'>
                        ...
                        <span className='text-transparent text-2xl md:text-3xl lg:text-5xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Aurapreneur</span>
                    </h1>
                </div>
