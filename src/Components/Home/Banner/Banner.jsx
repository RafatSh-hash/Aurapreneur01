...
const Banner = () => {
    return (
        ...
        <div id='homeBannerDiv' className='p-10 flex bg-black bg-opacity-80 w-full flex-row justify-evenly items-center'>
            <div className='w-full md:w-[60%] lg:w-[50%] mx-auto p-2 md:p-5 lg:p-10'>
                <button className='bg-transparent py-5 text-md md:text-lg lg:text-xl w-full md:w-[70%] lg:w-[75%] font-semibold text-white hover:bg-gray-200 hover:text-black transition-all duration-700 px-10 rounded-full border-2 border-white'>
                ...
                <div className="form-control">
                    <div className="input-group">
                        <input type="text" placeholder="Your Email Address" className="input w-full md:w-[60%] lg:w-[70%] mx-auto bg-gray-200 text-black input-bordered" />
